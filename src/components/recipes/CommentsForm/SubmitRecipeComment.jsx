...
export async function SubmitRecipeComment(formValues) {
  ...
  const recipeCommentData = formValues.get("comment_content");
  const recipeId = formValues.get("recipeId");

  db.query(
    `INSERT INTO recipe_comments (comment_content, recipe_id, user_id) 
        VALUES($1, $2, $3)`,
    [recipeCommentData, , finalUser]
  );
